$(function() {
  ...
  // we will want a more modular and fast way to store/update the word array - put it in a DB so we can choose words by length, commonality, part of speech, etc. - automated get updated word lists regularly?
  var wordArray = [
    'panda',
    'gumdrop',
    'pizza',
